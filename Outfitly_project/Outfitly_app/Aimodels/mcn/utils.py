...
from mcn.polyvore_dataset import CategoryDataset, collate_fn
...
def prepare_dataloaders(
    ...
    data_dir="data/",
    data_file_name="train_no_dup_with_category_3more_name.json",
    batch_size=16,
    img_size=224,
    use_mean_img=True,
    neg_samples=True,
    ...
    val_dataset = CategoryDataset(
        ...
        use_mean_img=use_mean_img,
        data_file=data_file_name,
        neg_samples=False  # Usually no negative sampling for validation
    )
